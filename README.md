...
[![Atmosphere: Cold & Clinical](https://img.shields.io/badge/Atmosphere-Clinical_%26_Claustrophobic-2b2b2b.svg?style=for-the-badge)](#)
[![Status: Concept / Design Doc](https://img.shields.io/badge/Status-Concept_%2F_In_Design-333333.svg?style=for-the-badge)](#)
[![Platform: PC](https://img.shields.io/badge/Platform-PC_%2F_Steam-444444.svg?style=for-the-badge)](#)
...
```mermaid
graph TD
    A[1. ANALYZE] -->|Listen to Audio Logs / CRT Feed| B[2. EXCISE]
    B -->|Scrub Key Identifiers & Emotions| C[3. INJECT]
    C -->|Splice State-Approved Directives| D[4. CONFRONT]
    D -->|Broadcast Memory & Monitor Breakdowns| E{Shift Evaluation}
    E -->|Conformity Achieved| F[Shift Passed / Advance Week]
    E -->|Mercy / Non-Compliance| G[Neural Tone Feedback / System Flag]
```
